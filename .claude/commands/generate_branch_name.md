...
Return ONLY the generated branch name. No explanation, no reasoning, no markdown formatting - just the branch name as a single line of text.

Example correct output:
```
feature-issue-115-adw-c38bb840-update-lucy-biography
```
