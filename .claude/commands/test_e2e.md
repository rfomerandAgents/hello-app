...
application_url: $ARGUMENT if provided, otherwise use default http://localhost:3000

## Instructions

- If `application_url` was not provided, use default http://localhost:3000 (Next.js default port)
