...
### Test 1: Dry-Run Mode
**Command:** `uv run adws/adw_tests/fix_health_check.py --dry-run`
...
**Command:** `uv run adws/adw_tests/fix_health_check.py --auto`
...
**Command:** `echo "y" | uv run adws/adw_tests/fix_health_check.py`
...
**Command:** `uv run adws/adw_tests/webhook_tunnel_health_check.py`
...
1. `adws/adw_tests/fix_health_check.py` (371 lines)
...
- Follows same patterns as other ADW test scripts
