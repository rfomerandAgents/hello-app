...
Usage:
    uv run ipe/ipe_tests/ipe_validate_r2_uploader.py
...
def test_r2_upload():
    ...
    object_key = f"adw/ipe_validate/r2_upload_test_{timestamp}_bg.png"
    ...
    url_mapping = uploader.upload_screenshots(test_screenshots, "test_ipe_id")
    ...
    print("3. Run IPE reviews - screenshots will be automatically uploaded")
