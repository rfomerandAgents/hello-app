...
Usage:
    ...
    ./ipe/ipe_slash_command.py /chore "Update documentation"

    # Method 2: Using uv run
    uv run ipe/ipe_slash_command.py /ipe_build specs/<name-of-spec>.md

    uv run ipe/ipe_slash_command.py /start


Examples:
    # Run a slash command
    ./ipe/ipe_slash_command.py /chore "Add logging to agent.py"

    # Run with specific model
    ./ipe/ipe_slash_command.py /ipe_build plan.md --model opus

    # Run from a different working directory
    ./ipe/ipe_slash_command.py /ipe_validate --working-dir /path/to/project

    # Use custom agent name
    ./ipe/ipe_slash_command.py /review --agent-name reviewer
"""
...
def main(
    ...
    info_table.add_row("IPE Name", "ipe_slash_command")
    ...
    try:
        ...
        # Output files are in agents/<ipe_id>/<agent_name>/
        output_dir = f"./agents/{ipe_id}/{agent_name}"
