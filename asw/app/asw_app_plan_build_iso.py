...
"""
ASW App Plan Build Iso - Compositional workflow for isolated planning and building

Usage: uv run asw_app_plan_build_iso.py <issue-number> [asw-id]
...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: uv run asw_app_plan_build_iso.py <issue-number> [asw-id]")
